...
gulp.task( "stats", [ "lint" ], function() {
  return gulp.src( "js/stats/*.js" )
...
gulp.task( "copy", function() {
  gulp.src([ "index.html", "stats.html", "manifest.json", "sw.js", "cache-polyfill.js" ])
    .pipe( gulp.dest( "dist/" ) );
